            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-800 text-slate-400 text-sm uppercase tracking-wider">
                  ...
                  <th className="py-4 px-4 font-semibold text-right">Reps / Sec</th>
                  <th className="py-4 px-4 font-semibold text-right">Accuracy</th>
                  <th className="py-4 px-4 font-semibold text-right hidden sm:table-cell">Confidence</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-800/50 text-white">
                {history.map((session) => (
                  <tr key={session.id} className="hover:bg-slate-800/20 transition-colors">
                    ...
                    <td className="py-4 px-4 text-right text-slate-500 hidden sm:table-cell">
                      {session.confidence}%
                    </td>
                  </tr>
                ))}
